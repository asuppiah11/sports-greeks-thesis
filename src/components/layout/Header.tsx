    ...
    <header className="border-b border-terminal-border bg-terminal-bg">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-7 sm:py-9">
        <div className="max-w-3xl">
          <h1 className="font-sans text-xl sm:text-2xl font-bold text-terminal-text leading-tight mb-1.5">
            Quantifying Market Greeks in Soccer Betting
          </h1>
          <p className="font-sans text-base text-terminal-muted font-normal mb-3">
          ...
          <p className="font-sans text-sm text-terminal-muted mb-5 max-w-2xl leading-relaxed">
